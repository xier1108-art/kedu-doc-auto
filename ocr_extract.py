...
‼ 기본값은 [A] 공문. [B] 는 엄격 조건 모두 만족할 때만. 의심 시 [A].

[A] 일반 공문 표지 (다음 중 일부만 있어도):
  ✓ "수신:", "참조:", "제목:" 라벨
  ✓ 하단 "시행 {{회사}}({{학교}})제YYYY-N호({{날짜}})" 줄
  ✓ "끝." + 직인

[B] 조달청 검사검수요청서 — ⚠ 3개 조건 ★모두★ 만족해야:
  ★1. 페이지 상단 헤더에 "검 사 검 수 요 청 서" 또는 "검사검수요청서" 가
       큰 글자로 단독 (본문 인용 표현은 X)
  ★2. "※나라장터전자문서출력물" 표기
  ★3. "[공공기관]" / "[납품업체]" 박스 구조 + "기 관 명:", "업 체 명:" 등 라벨

  ⚠ 다음은 [B] 아님 → [A]:
    - "수신:" 줄이 있는 문서
    - 본문에 "검사검수" 단어만 등장하는 일반 공문 (예: "○○ 검사검수 요청 보고")
    - 헤더만 있고 [공공기관]/[납품업체] 박스 없음
...
═══════ [A 유형 — 일반 공문] ═══════
[발신자] 다음 3곳 중에서 회사명/기관명 (서로 일치해야 신뢰):
  ★ 표지 최상단 큰 글자 (예: "장위토건", "㈜대성씨엠건축사사무소")
  ★ 표지 하단 발신명의 영역의 회사명 (직인 옆)
  ★ 직인 자체의 회사명
  ✗ 절대 발신자가 아닌 것:
    - "우 12345 주소: ..." 주소 줄
    - 행정구역명 단독 ("서울특별시 동대문구") — 주소의 일부
    - 직인 옆 사람 이름 (대표이사/소장 이름)
    - 본문 인용 "설계사공문: DNB ..." 외부 공문번호
